...
export const ProyectContext = createContext<IProjectContext>(projectContextInitialValue);

export function TaskContextProvider(props) {
  const [projects, setProjects] = useState<Project[]>([])
  const [proyectSelected, setProyectSelected] = useState<Project>(projectContextInitialValue.proyectSelected)

  //DATA
  useEffect(() => {
    let localData:Project[] = JSON.parse(localStorage.getItem("projects") ?? '[]');
